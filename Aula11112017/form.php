...
<body class="container">
    ...
    <form method="post" action="consulta.php" class="col s12 formCep z-depth-2">
        <div class="row">
            ...
            <div class="input-field col s6">
                <input placeholder="Digite o CEP de Destino" id="cepDestino" name="cepDestino" type="text" class="validate">
                <label for="cepDestino">CEP de Destino</label>
            </div>
            <div class="input-field col s6">
                <input placeholder="Digite o codigo do Serviço. 04014" id="codServico" name="codServico" type="number" class="validate">
                <label for="codServico">Codigo do Serviço</label>
            </div>
        </div>
